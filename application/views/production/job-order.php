    ...
    <div class="col-md-12">
        <div class="box box-solid">
                ...
                <div class="pull-right box-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="<?= base_url('production/job_order/create') ?>">Create new job order</a></li>
            ...
            <div class="box-body no-padding">
                <?php $url = base_url('production/job_order'); ?>
                <table id="jo-master-list" class="table table-striped table-condensed promix" data-edit-url='<?= $url . '/update/' ?>' 
                       ...
                       data-receive-url='<?= base_url("warehousing/receiving/create?jo_no=") ?>'>
