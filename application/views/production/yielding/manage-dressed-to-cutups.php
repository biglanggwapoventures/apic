    				...
    				<?php foreach( $processed AS $index => $item ):?>
    					<tr>
	    					...
	    					<td>
	    						...
	    						<?php endif;?>
	    						<?= arr_group_dropdown("yield[to][{$index}][product_id]", $result_items, 'id', 'description', put_value($item, 'fk_inventory_product_id', FALSE), 'category_description', "class=\"form-control\" data-name=\"yield[to][idx][product_id]\"")?>
    						</td>
    						<td>
