<?php $url = base_url('production/yielding'); ?>
        ...
        <div class="pull-right box-tools">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?= "{$url}/create?type=live-to-dressed"?>">Process live to dressed</a></li>
                    <li><a href="<?= "{$url}/create?type=dressed-to-cutups"?>">Process dressed to cutups</a></li>
