...
<html>
    ...
    <body>
        <h4>JOB ORDER</h4>
        <p>Job Order #:<span class="trip-ticket-id"><?= $contents['ID'] ?></span></p>
        <table class="no-border general-info">
            <tr><td>Date:</td><td><?= $contents['date_assigned'] ?></td></tr>
            <tr><td>Assigned To:</td><td><?= $contents['assigned_to'] ?></td></tr>
