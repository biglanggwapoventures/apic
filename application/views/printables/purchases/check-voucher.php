    ...
    <body>
        <div class="container-fluid content" style="height:5in;">
                ...
                <div class="col-xs-8">
                    <table>
                        <tbody>
                            ...
                            <tr><td class="labels">Check No.:</td><td class='customer-info'><strong><?= "{$data['checks'][0]['bank_name']}#{$data['checks'][0]['check_number']}" ?></strong></td></tr>
                            <tr><td class="labels">Check Date:</td><td class='customer-info'><strong><?= date('m/d/Y') ?></strong></td></tr>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-4">
                    <table>
                        <tbody>
                            <tr><td class="labels">Voucher No.</td><td class='text-center customer-info'><strong> (Ref.) PO# <?= str_pad($data['checks'][0]['id'], 4, 0, STR_PAD_LEFT) ?></strong></td></tr>
                            <tr><td class="labels">Date:</td><td class='text-center customer-info'><strong><?= date('m/d/Y', strtotime($data['checks'][0]['check_date'])) ?></strong></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
                ...
                <div class='col-xs-12'>
                    <table style="width:100%">
                        <tbody>
                            ...
                            <?php endfor;?>
                            <tr>
                                <td class="text-center"><?= $data['checks'][0]['remarks']?></td>
                            </tr>
                            <?php for($x = 0; $x<7; $x++):?>
                                <tr><td>&nbsp;</td></tr>
                            <?php endfor;?>
            ...
            <div id='footer' style="margin-top:20px">
                <div class='row'> 
                    <div class='col-xs-9'>
                        <p>AMOUNT: <strong><?= convertCurrencyToWords(number_format($data['checks'][0]['amount'], 2, '.', '')); ?></strong></p>
                    </div>
                    <div class='col-xs-3'>
                        <p class='text-right'>TOTAL(Php): <strong ><?= number_format($data['checks'][0]['amount'], 2) ?></strong></p>
                    </div>
                </div>
                <div class='row'> 
                    <div class='col-xs-2'>
