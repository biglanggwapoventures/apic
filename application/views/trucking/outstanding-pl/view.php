                    ...
                    <div class="col-sm-12">
                        <table id="oplr" class="table table-bordered table-condensed borderless"
                            ...
                            <tbody>
                                ...
                                <tr class="static"><td class="text-center">PL#</td><td class="text-center" colspan="3">AMT</td><td class="text-center">DATE</td><td class="text-center">AR#</td><td class="text-center">CHK#</td><td class="text-center">CHK DATE</td><td class="text-center">DEPOSIT DATE</td><td class="text-center" colspan="2">AMOUNT</td></tr>
