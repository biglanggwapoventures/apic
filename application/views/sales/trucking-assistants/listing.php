        ...
        <div class="box box-solid">
                ...
                <div class="pull-right box-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="<?= "{$url}/create"?>">Create new assistant</a></li>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped"> 
                    <thead><tr class="info"><th>Name</th><th>Status</th><th></th></tr></thead>
                    <tbody>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-danger text-center text-bold">Confirm deletion?<br> <u>This action cannot be undone.<u></p>
            </div>
