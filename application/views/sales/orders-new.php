    ...
    <div class="col-md-12">
        <div class="box box-solid">
                ...
                <div class="pull-right box-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="<?php echo base_url('sales/orders/add'); ?>">Add new sales order</a></li>
            ...
            <div class="box-body no-padding" style="display: block;">
                <div class="row">
                    <div class="col-xs-12">
                        <?php $so_url = base_url('sales/orders'); ?>
                        <table id="so-master-list" class="table table-striped table-condensed promix" data-edit-url='<?= $so_url . '/update/' ?>' 
                               data-master-list-url='<?= $so_url . '/a_master_list' ?>'
                               data-delete-url='<?= $so_url . '/a_delete/' ?>'>
                            <thead>
                                <tr class="info"><th>S.O. #</th><th>P.O. #</th><th>Date</th><th>Customer</th><th>Total Amount</th><th>Status</th><th class="text-right"></th></tr>
