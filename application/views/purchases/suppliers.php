        ...
        <div class="box box-solid">
            ...
            <div class="box-body no-padding">
                <table class="table table-hover  list">
                    <?php $url = base_url('purchases/suppliers'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var initializeEditable = function (element) {
            element.editable({
                type: 'text',
                url: "<?= base_url('purchases/suppliers/ajax_update') ?>",
                pk: function () {
        ...
        $('#new-entry').submit(function (event) {
            ...
            var request = $.post("<?= base_url('purchases/suppliers/ajax_add') ?>", $this.serialize());
        ...
        $('.list').on('click', '.remove-item', function (event) {
            ...
            var request = $.post("<?= base_url('purchases/suppliers/ajax_delete') ?>", {
                'id': _id
            });
