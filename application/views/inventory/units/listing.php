<?php $url = base_url('inventory/units'); ?>
<div class="row">
    <div class="col-md-6">
        <div class="box box-solid">
                ...
                <div class="pull-right box-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="<?= "{$url}/create"?>">Create new unit</a></li>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped"> 
                    <thead><tr class="info"><th>Description</th><th>Status</th><th></th></tr></thead>
                    <tbody>
                        <?php foreach($items AS $row):?>   
                            <tr data-pk="<?= $row['id']?>">
                                <td><a href="<?= "{$url}/edit/{$row['id']}"?>"><?= $row['description']?></a></td>
                                <td>
                        ...
                        <?php endforeach;?>
                        <?php if(empty($items)):?>
                            <tr><td colspan="3" class="text-center">No data to show.</td></tr>
                        <?php endif;?>
                    </tbody>
                </table>
            </div><!-- /.box-body -->  
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-danger text-center text-bold">Do you really want to delete this unit?<br> <u>This action cannot be undone.<u></p>
            </div>
