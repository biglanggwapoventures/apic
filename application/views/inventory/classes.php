            ...
            <div class="col-md-6">
                <div class="btn-toolbar">
                    <a class="btn btn-success" role="button" data-target=".pm-inventory-modal" data-toggle="modal"> 
                        <i class="glyphicon glyphicon-plus"></i> Add new product class
                    </a>
                </div>
            </div>
            <div class="col-md-6">
                <form method="get" action="<?= base_url('inventory/classes') ?>">
                ...
                <div class="box box-info">
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover pm-table">
                            ...
                            <tbody class="pm-inventory-tbody" data-edit-url="<?= base_url('inventory/classes/a_update') ?>" data-delete-url="<?= base_url('inventory/classes/a_delete') ?>">
        ...
        <div class="modal fade pm-inventory-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="pm-inventory-form" method="post" action="<?= base_url('inventory/classes/a_add') ?>">
