<input type="hidden" name="data-so-link" value="<?= base_url('sales/deliveries/update') ?>">
<div class='row'>
    <div class='col-md-12'>
        <form class="form-inline" role="form" action='<?= base_url('reports/customer_ledger/generate') ?>'>
