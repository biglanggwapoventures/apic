        ...
        <div class="box box-solid">
                ...
                <div class="pull-right box-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="<?= "{$url}/create"?>">Create new sales agent</a></li>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped"> 
                    <thead><tr class="info"><th>Agent code</th><th>Name</th><th>Area</th><th>Commission rate</th><th>Status</th><th></th></tr></thead>
                    <tbody>
